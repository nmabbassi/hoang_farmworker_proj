...
ggplot(merge_data, aes(x=reorder(city, imp_water, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="Summed number of pollutants across water bodies designated as impaired within the area, 2012.",
...
ggplot(merge_data, aes(x=reorder(city, low_birth, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="Percent low birth weight, (averaged over 2006-2012).",
...
ggplot(merge_data, aes(x=reorder(city, card_disease, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="Spatially modeled, age-adjusted rate of emergency department visits for AMI per 10,000 (averaged over 2011-2013).",
...
ggplot(merge_data, aes(x=reorder(city, poverty, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="% population living below two times the federal poverty level (5-year estimate, 2011-2015)",
...
ggplot(merge_data, aes(x=reorder(city, unemploy, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="% population over 16 that is unemployed, 2011-2015",
...
ggplot(merge_data, aes(x=reorder(city, housing_burden, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="City in Ventura County",
       y="% of households in a census tract that are low income, 2009-2013.",
