...
ggplot(merge_data, aes(x=reorder(city, ozone, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County",
       y="Mean of summer months (May-Oct) of daily max. 8-hr ozone concentration (ppm), avgerage from 2012 to 2014",
...
ggplot(merge_data, aes(x=reorder(city, pm_2.5, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County",
       y="Annual mean concentration of PM2.5 (avg of quarterly means, μg/m3) from 2012 to 2014",
...
ggplot(merge_data, aes(x=reorder(city, pesticides, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County",
       y="Total lbs of pesticide ingredients used in production-agriculture per square mile from 2012 to 2014.",
...
ggplot(merge_data, aes(x=reorder(city, tox_release, median, na.rm=TRUE),
  ...
  geom_boxplot(fill="cornflowerblue", outlier.color = "tan2")+
  theme_bw()+
  labs(x="NName of City in Ventura County",
...
ggplot(merge_data, aes(x=reorder(city, education, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County",
       y="Percent of population over 25 with less than a high school education (5-year estimate, 2011-2015)",
...
ggplot(merge_data, aes(x=reorder(city, ling_isolation, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County",
       y="Percent of limited English-speaking Households, averaged from 2011 to 2015",
...
ggplot(merge_data, aes(x=reorder(city, poverty, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County by City",
       y="Percent of population living below two times the federal poverty level, 5-year estimate from 2011 to 2015",
...
ggplot(merge_data, aes(x=reorder(city, unemploy, median, na.rm=TRUE),
  ...
  theme_bw()+
  labs(x="Name of City in Ventura County by City",
       y="Percent of population over 16 that is unemployed, averaged from values between 2011 and 2015",
