...
ggplot(merge_data, aes(x=reorder(city, low_birth, median, na.rm=TRUE),
  ...
  labs(x="Name of City in Ventura County",
       ...
       title="Low birth rates in Ventura County by City",
       caption="Data from CalEnviroScreen")+
  theme(axis.title=element_text(size=10))+
  theme(plot.title=element_text(size=10))+
  theme(plot.caption=element_text(size=6))+
...
ggplot(merge_data, aes(x=reorder(city, ling_isolation, median, na.rm=TRUE),
  ...
  labs(x="Name of City in Ventura County",
       ...
       title="Linguistic Isolation in Ventura County by City",
       caption="Data from CalEnviroScreen")+
  theme(axis.title=element_text(size=10))+
  theme(plot.title=element_text(size=10))+
  theme(plot.caption=element_text(size=6))+
...
5-year estimate between 2011 and 2015",
       title="Poverty Rates in Ventura County by City",
       caption="Data from CalEnviroScreen")+
  theme(axis.title=element_text(size=10))+
  theme(plot.title=element_text(size=10))+
  theme(plot.caption=element_text(size=6))+
...
ggplot(merge_data, aes(x=reorder(city, housing_burden, median, na.rm=TRUE),
  ...
  labs(x="Name of City in Ventura County",
       ...
       title="Housing Burdened Low Income Households in Ventura County by City",
       caption="Data from CalEnviroScreen")+
  theme(axis.title=element_text(size=10))+
  theme(plot.title=element_text(size=10))+
  theme(plot.caption=element_text(size=6))+
